...
static s32 _DrvFwCtrlUpdateFirmwareCash(u8 szFwData[][1024], EmemType_e eEmemType)
{
    ...
    {
        _DrvFwCtrlMsg28xxGetTpVendorCode(_gTpVendorCode);
        ...
        {
            return _DrvFwCtrlMsg28xxUpdateFirmware(szFwData, eEmemType);
        }
    }
    else 
    {
...
void _DrvFwCtrlMsg28xxCheckFirmwareUpdateBySwId(void) 
{
    ...
    nCrcInfoA = _DrvFwCtrlMsg28xxGetFirmwareCrcByHardware(EMEM_INFO);
    nCrcInfoB = _DrvFwCtrlMsg28xxRetrieveFirmwareCrcFromEFlash(EMEM_INFO);
...
static void _DrvFwCtrlUpdateFirmwareBySwIdDoWork(struct work_struct *pWork)
{
    ...
    else if (g_ChipType == CHIP_TYPE_MSG28XX)    
    {
        ...
        {
            nRetVal = _DrvFwCtrlMsg28xxUpdateFirmwareBySwId();
        }
    }
    else
    {
