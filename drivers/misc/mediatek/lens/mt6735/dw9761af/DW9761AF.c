...
#define AF_DRVNAME "DW9761AF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x18
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9761af"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9761af"
...
inline static int getAFInfo(__user stDW9761AF_MotorInfo * pstMotorInfo)
{
    stDW9761AF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stDW9761AF_MotorInfo)))
    {
...
#ifdef LensdrvCM3
inline static int getAFMETA(__user stDW9761AF_MotorMETAInfo * pstMotorMETAInfo)
{
    stDW9761AF_MotorMETAInfo stMotorMETAInfo;
    ...
    if(copy_to_user(pstMotorMETAInfo , &stMotorMETAInfo , sizeof(stDW9761AF_MotorMETAInfo)))
    {
        LOG_INF("copy to user failed when getting motor information \n");
    }
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9761AFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9761AF_MotorInfo *)(a_u4Param));
        break;
        #ifdef LensdrvCM3
        case DW9761AFIOC_G_MOTORMETAINFO :
            i4RetValue = getAFMETA((__user stDW9761AF_MotorMETAInfo *)(a_u4Param));
        break;
        #endif
        case DW9761AFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;

        case DW9761AFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case DW9761AFIOC_T_SETMACROPOS :
...
static int AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    char puSendCmd4[2] = {(char)(0x07) , (char)(0x22)};
...
static int __init DW9761AF_i2C_init(void)
{
...
static void __exit DW9761AF_i2C_exit(void)
{
    platform_driver_unregister(&g_stAF_Driver);
}

module_init(DW9761AF_i2C_init);
module_exit(DW9761AF_i2C_exit);
