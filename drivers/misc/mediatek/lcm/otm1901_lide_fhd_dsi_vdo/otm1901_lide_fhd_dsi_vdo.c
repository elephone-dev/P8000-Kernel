...
//Shift1 2 3 -->Shift Fixed Code
		...
		{0x00,1,{0x00}},
		{0xE1,24,{0x1,0xC,0x19,0x27,0x31,0x39,0x46,0x58,0x63,0x77,0x83,0x8C,0x6D,0x69,0x66,0x58,0x47,0x37,0x2C,0x26,0x1E,0x14,0xF,0x6}},
		{0x00,1,{0x00}},
		{0xE2,24,{0x1,0xC,0x19,0x27,0x31,0x39,0x46,0x58,0x63,0x77,0x83,0x8C,0x6D,0x69,0x66,0x58,0x47,0x37,0x2C,0x26,0x1E,0x14,0xF,0x6}},
		{0x00,1,{0x00}},
		{0xE3,24,{0x1,0xC,0x19,0x27,0x31,0x39,0x46,0x58,0x63,0x77,0x83,0x8C,0x6D,0x69,0x66,0x58,0x47,0x37,0x2C,0x26,0x1E,0x14,0xF,0x6}},
		{0x00,1,{0x00}},
		{0xE4,24,{0x1,0xC,0x19,0x27,0x31,0x39,0x46,0x58,0x63,0x77,0x83,0x8C,0x6D,0x69,0x66,0x58,0x47,0x37,0x2C,0x26,0x1E,0x14,0xF,0x6}},
		{0x00,1,{0x00}},
...
static void lcm_init(void)
{
	...
	if(ret<0)
	printk("[KERNEL]otm1901_lide----tps6132---cmd=%0x-- i2c write error-----\n",cmd);
	else
	printk("[KERNEL]otm1901_lide----tps6132---cmd=%0x-- i2c write success-----\n",cmd);
...
static unsigned int lcm_compare_id(void)
{
	...
	id = buffer[0];
#ifdef BUILD_LK
	printf("%s,  otm1901_lide id = 0x%08x\n", __func__, id);
#else
	printk("%s,  otm1901_lide id = 0x%08x\n", __func__, id);
#endif
...
LCM_DRIVER otm1901_lide_fhd_dsi_vdo_lcm_drv = 
{
	.name				= "otm1901_lide_fhd_dsi_vdo",
