...
//  Local Constants
// ---------------------------------------------------------------------------
#define LCM_ID										0xb1b1//0x1080//1a//0x40
...
{0xB4,1,{0x02}},  // 00:column,02:2-dot

{0xE3,4,{0x09,0x09,0x03,0x03}},  // 


{0xB6,2,{0x3F,0x3F}},	//VCOM OFFSET

{0xE9,51,{0x00,0x00,0x05,0x00,0x00,0x0A,0x80,0x12,
					0x30,0x00,0x33,0x09,0x0A,0x80,0x37,0x00,
					0x03,0x00,0x00,0x00,0x00,0x08,0x98,0x98,
					0x20,0x64,0x02,0x88,0x88,0x88,0x88,0x98,
					0x98,0x31,0x75,0x13,0x88,0x88,0x88,0x88,
					0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
					0x00,0x00,0x00}},
 

{0xEA,22,{0x06,0x00,0x00,0x00,0x89,0x89,0x57,0x13,
					0x31,0x88,0x88,0x88,0x88,0x89,0x89,0x46,
					0x02,0x20,0x88,0x88,0x88,0x88}},


{0xE0,34,{0x00,0x00,0x00,0x0C,0x0F,0x3F,0x0F,0x2D,
					0x02,0x09,0x10,0x14,0x17,0x16,0x16,0x13,
					0x1A,0x00,0x00,0x00,0x0C,0x0F,0x3F,0x0F,
					0x2D,0x02,0x09,0x10,0x14,0x17,0x16,0x16,
				0x13,0x1A}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch				= 31;//100;
	params->dsi.horizontal_frontporch				= 31;//40;
...
#if defined(BUILD_LK)
			  printf("lk -- fl10802 0x%x , 0x%x , 0x%x, 0x%x \n", id_high, id_midd, id_low, id);
#else
			  printk("kernel -- fl10802 0x%x , 0x%x , 0x%x, 0x%x \n", id_high, id_midd, id_low, id);
#endif

		 return (id == LCM_ID)?1:0;
}

LCM_DRIVER fl10802_dsi_vdo_fwvga_drv = 
{
	.name				= "fl10802_dsi_vdo_fwvga",
